        ...
        <div className='contact__content'>
          ...
          <div className='contact__info'>
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>vinaykhatri292@gmail.com</span>
              <a href='mailto: vinaykhatri292@gmail.com' target="_blank" className='contact__button'> Write me{" "}
            ...
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>+91 9311842027</span>
            ...
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>@0_vinay_khatri_0</span>
              <a href='https://www.instagram.com/0_vinay_khatri_0/' target="_blank" className='contact__button'> Write me
